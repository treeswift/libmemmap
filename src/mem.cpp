...
// mlockall, munlockall: no such shortcuts on Windows. The process will have to iterate through
...
// mincore: VirtualQuery (iterative call of, once per homogeneous page range)
